...
namespace Dolinay
{
    ...
    internal class DetectorForm : Form
    {
        ...
        /// <summary>
        /// This can be use to get previously connected Removable devices. Returns drive letter D,E,F.
        /// </summary>
        /// <returns></returns>
        public static string[] GetConnectedUSB()
        {
            if (!IsElevated)
                throw new Exception("Requires admin rights to execute GetConnectedUSB");
